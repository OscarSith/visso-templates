...
class ProductosTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $productos = [
        	...
        	// Operativos
            ['cat_id' => 11, 'pro_nombre' => 'SERVA', 'pro_descripcion' => '<p>La principal característica de esta línea de escritorios es el diseño del tablero de trabajo que proporciona los siguientes beneficios:</p>
<ul><li>Amplia superficie de trabajo. Mayor cobertura y acceso a la superficie de trabajo.</li>
<li>Modularidad, los escritorios son modulares entre si permitiendo que se acoplen y formen grupos de trabajo.</li>
<li>Ubicación del monitor en la esquina del mueble, esto mejora la longitud optima de observación.</li>
<li>Comodidad y libertad de movimientos debajo del tablero.</li>
<li>Eliminación de la bandeja porta teclado lo que permite ganar una mayor área de trabajo y evitar la incomodidad de tener el porta teclado sobre las rodillas.</li>
</ul><p>Dimensiones: A partir de 1.40 m.<br>
Tableros disponibles: 18 mm, 24 mm y 30 mm.<br>
La variante ergonomica Serva posee soportes curvos y un embellecedro en la cajonera fija pedestal.</p>', 'pro_imagen_default' => 'visso-escritorio-operativos-linea-serva.jpg'],
            ...
            ['cat_id' => 11, 'pro_nombre' => 'MISKI', 'pro_descripcion' => '<p><strong>Características</strong></p><p>Funcional escritorio de trabajo en L.</p><p>Tablero frontal recto o con terminación curva para utilizarlo como espacio de reuniones.</p><p>Cajonera fija.</p>', 'pro_imagen_default' => 'visso-escritorio-operativos-linea-miski.jpg'],
            ['cat_id' => 11, 'pro_nombre' => 'PORTICO', 'pro_descripcion' => '<p><strong>Características</strong></p>
<p>Escritorio en L operativo de melamina. De líneas rectas disponible en variedad de colores combinables.
Cajonera fija o móvil con cerradura centralizada.</p>
<p>Tableros de 18 mm. o de 24 mm. de espesor (según las dimensiones del escritorio)<br>Dimensiones disponibles: 1.30 x 1.30 m., 1.40 x 1.40 m., 1.50 x 1.50 m., 1.60 x 1.60 m., 1.70 x 1.70 m., otras medidas consultar.</p>', 'pro_imagen_default' => 'visso-escritorio-operativos-linea-portico.jpg'],
        	...
        	// Gerenciales
            ['cat_id' => 13, 'pro_nombre' => 'Integra', 'pro_descripcion' => '', 'pro_imagen_default' => 'visso-silloneria-integra.jpg'],
            ...
            ['cat_id' => 13, 'pro_nombre' => 'Consiglieri Trineo', 'pro_descripcion' => '<ul><li>Sillón con asiento y respaldo bajo anatómico tapizado en cuero sintético.</li><li>Consigliere es ideal para liderar y aconsejar cómodamente. Cuenta con brazos de aluminio tapizados en cuero sintético.</li><li>Silla fija con estructura metálica cromada.</li></ul>', 'pro_imagen_default' => 'visso-silloneria-consiglieri-trineo.jpg'],
            ...
            ['cat_id' => 13, 'pro_nombre' => 'Guru Trineo', 'pro_descripcion' => '<ul><li>Asiento y respaldo anatómico tapizado en símil cuero.<li>Brazos de aluminio tapizados y altura regulable.</li><li>Su diseño perdura en el tiempo, como los resultados de las grandes decisiones. </li><li>Silla fija con estructura metálica cromada.</li></ul>', 'pro_imagen_default' => 'visso-silloneria-guru-trineo.jpg'],
            // ['cat_id' => 13, 'pro_nombre' => 'Senior', 'pro_descripcion' => '', 'pro_imagen_default' => 'visso-silloneria-consiglieri-trineo.jpg'],

        	// Operativos
        	['cat_id' => 14, 'pro_nombre' => 'Clio', 'pro_descripcion' => '<ul><li>Respaldar bajo ajustable en altura y tapizado en malla color negro.</li><li>Asiento de espuma inyectada de alta duración que garantiza el confort sin deformarse y tapizada con tela importada retardante al fuego.</li><li>Asiento con borde en cascada para aliviar la presión ejercida sobre las rodillas.</li><li>Base anti vuelcos de nylon reforzado.</li><li>Brazos regulables en altura, cumple con la Norma Básica de Ergonomía.</li></ul>', 'pro_imagen_default' => 'visso-silloneria-operativos-clio.jpg'],
            ['cat_id' => 14, 'pro_nombre' => 'Clio Cajera', 'pro_descripcion' => '<ul><li>Respaldar bajo ajustable en altura y tapizado en malla color negro. </li><li>Asiento de espuma inyectada de alta duración que garantiza el confort sin deformarse y tapizada con tela importada retardante al fuego.</li><li>Asiento con borde en cascada para aliviar la presión ejercida sobre las rodillas.</li><li>Base anti vuelcos de nylon reforzado. </li><li>Brazos regulables en altura, cumple con la Norma Básica de Ergonomía.</li><li>Sistema cajera</li></ul>', 'pro_imagen_default' => 'visso-silloneria-operativos-clio-cajera.jpg'],

            ['cat_id' => 14, 'pro_nombre' => 'Confort', 'pro_descripcion' => '<ul><li>Respaldo medio REGULABLE de malla, que garantiza un alto confort y elegancia gracias a su elasticidad y transpiración.</li><li>Mecanismo basculante que permite balancear el respaldar y asiento, regulándose de acuerdo al peso del usuario.</li><li>Cuenta con brazos regulables en 03 dimensiones (alto, ancho y profundidad).</li><li>Espuma inyectada de alta duración que garantiza el confort sin deformarse y tapizada con tela importada retardante al fuego.</li><li>Base anti vuelcos de nylon reforzado, soporta una carga de 1200 kg. sin romperse.</li><li>Base tipo aspa de 5 puntas de polipropileno</li></ul>', 'pro_imagen_default' => 'visso-silloneria-operativos-confort.jpg'],

            ['cat_id' => 14, 'pro_nombre' => 'Confort base de aluminio', 'pro_descripcion' => '<ul><li>Respaldo medio REGULABLE de malla, que garantiza un alto confort y elegancia gracias a su elasticidad y transpiración.</li><li>Mecanismo basculante que permite balancear el respaldar y asiento, regulándose de acuerdo al peso del usuario.</li><li>Cuenta con brazos regulables en 03 dimensiones (alto, ancho y profundidad).</li><li>Espuma inyectada de alta duración que garantiza el confort sin deformarse y tapizada con tela importada retardante al fuego.</li><li>Base anti vuelcos de nylon reforzado, soporta una carga de 1200 kg. sin romperse. </li><li>Base tipo aspa de 5 puntas reforzadas de metal aluminizado</li></ul>', 'pro_imagen_default' => 'visso-silloneria-operativos-confort-b-aluminio.jpg'],

            ['cat_id' => 14, 'pro_nombre' => 'Guiatta', 'pro_descripcion' => '<ul><li>Silla de respaldar alto tapizado.</li><li>Sistema SYNCRO que permite el movimiento sincronizado del respaldo y el asiento con sistema de bloqueo en la posición deseada, además permite la inclinación independiente del asiento hacia delante o hacia atrás, esto le da total libertad al usuario de configurar la silla a su comodidad.</li><li>Espuma inyectada de alta duración que garantiza el confort sin deformarse y tapizada con tela importada retardante al fuego.</li><li>Novedosos Brazos regulables en : ancho, fondo y altura.</li><li>Base tipo aspa de 5 puntas de polipropileno</li></ul>', 'pro_imagen_default' => 'visso-silloneria-operativos-guiatta.jpg'],

            ['cat_id' => 14, 'pro_nombre' => 'Guiatta con base de aluminio', 'pro_descripcion' => '<ul><li>Silla de respaldar alto tapizado.</li><li>Sistema SYNCRO que permite el movimiento sincronizado del respaldo y el asiento con sistema de bloqueo en la posición deseada, además permite la inclinación independiente del asiento hacia delante o hacia atrás, esto le da total libertad al usuario de configurar la silla a su comodidad. </li><li>Espuma inyectada de alta duración que garantiza el confort sin deformarse y tapizada con tela importada retardante al fuego.</li><li>Novedosos Brazos regulables en : ancho, fondo y altura.</li><li>Base tipo aspa de 5 puntas reforzadas de metal aluminizado</ul>', 'pro_imagen_default' => 'visso-silloneria-operativos-guiatta-b-aluminio.jpg'],
            ...
            ['cat_id' => 14, 'pro_nombre' => 'Smart con base de aluminio', 'pro_descripcion' => '<ul><li>Respaldo alto REGULABLE de malla garantiza un alto confort y elegancia gracias a su elasticidad y transpiración.</li><li>Mecanismo basculante que permite balancear el respaldar y asiento, regulándose de acuerdo al peso del usuario.</li><li>Cuenta con brazos regulables en 02 dimensiones (alto y ancho).</li><li>Asiento con borde en cascada para aliviar la presión ejercida sobre las rodillas., tapizada con tela importada retardante al fuego.</li><li>Base anti vuelcos de nylon reforzado. Soporta una carga de 1200 kg.</li><li>Base tipo aspa de 5 puntas reforzadas de metal aluminizado</li></ul>', 'pro_imagen_default' => 'visso-silloneria-operativos-smart-b-aluminio.jpg'],

            ['cat_id' => 14, 'pro_nombre' => 'Smart con base de aluminio y cabecera', 'pro_descripcion' => '<ul><li>Respaldo alto REGULABLE de malla garantiza una alto confort y elegancia gracias a su elasticidad y transpiración.</li><li>Mecanismo basculante que permite balancear el respaldar y asiento, regulándose de acuerdo al peso del usuario.</li><li>Cuenta con brazos regulables en 02 dimensiones (alto y ancho).</li><li>Asiento con borde en cascada para aliviar la presión ejercida sobre las rodillas., tapizada con tela importada retardante al fuego.</li><li>Base anti vuelcos de nylon reforzado. Soporta una carga de 1200 kg.</li><li>Base tipo aspa de 5 puntas reforzadas de metal aluminizado</li><li>Apoya cabecera regulable en Nylon</li>', 'pro_imagen_default' => 'visso-silloneria-operativos-smart-b-aluminio-cabecera.jpg'],
            ...
            ['cat_id' => 15, 'pro_nombre' => 'VERSA', 'pro_descripcion' => '<ul><li>Las estructuras  04 patas son cromadas lo cual garantiza su durabilidad en diferente s condiciones de uso.</li><li>Son apilables.</li><li>Respaldo tapizado en tela.</li></ul>', 'pro_imagen_default' => 'visso-silloneria-visita-versa.jpg'],
            ['cat_id' => 15, 'pro_nombre' => 'FLIP', 'pro_descripcion' => '<ul><li>El diseño y fabricación italiana de la silla Step ofrece confort, robustez, funcionalidad y diseño en un solo modelo de silla.</li></ul>', 'pro_imagen_default' => 'visso-silloneria-visita-flip.jpg'],
            ['cat_id' => 15, 'pro_nombre' => 'UP', 'pro_descripcion' => '<ul><li>El diseño y fabricación italiana de la silla Step ofrece confort, robustez, funcionalidad y diseño en un solo modelo de silla.</li><li>Las estructuras  04 patas son cromadas lo cual garantiza su durabilidad en diferente s condiciones de uso.</li><li>Son apilables.</li><li>Respaldo tapizado en tela.</li></ul>', 'pro_imagen_default' => 'visso-silloneria-visita-up.jpg'],

        	// Sistemas modulares
        	['cat_id' => 6, 'pro_nombre' => 'SISTEMA DE PANELES', 'pro_descripcion' => '<p><strong>Características</strong></p><p>Los sistemas de paneles de Visso están diseñados para que cada miembro de tu equipo pueda concentrarse cómodamente dentro de su propio espacio de trabajo.</p><p>Su concepto modular permite modificar las configuración de los espacios, adaptándose a futuros cambios o ampliaciones dentro de su empresa.</p>><p><strong>Beneficios:</strong><p><ul><li>Aumentan la productividad: Mediante atmosferas independientes y creativas en ambientes de trabajo sanos y motivadores.</li><li>Optimiza el espacio disponible y  Facilita la organización de su empresa.</li><li>Mejora enormemente su imagen frente a su cliente.</li><ul><p><strong>Especificaciones técnicas:</strong></p><ul><li>06 Alturas disponibles: 0.94 m., 1.20 m., 1.34 m. , 1.50 m., 1.74 m. y de piso a techo.</li><li>Amplias canaletas para el cableado de voz y data.</li><li>Espesor 7.5 cm.</li><li>Estructura metálica en acero cold rolled.</li><li>Baldosas de tela, enchapadas en madera, formica o vidrio.</li></ul>', 'pro_imagen_default' => 'visso-sistemas-modulares-paneles.jpg'],

        	// Escritorios BENCH
        	['cat_id' => 6, 'pro_nombre' => 'SISTEMAS BENCH', 'pro_descripcion' => '<p><strong>Características</strong></p><p>Diseño limpio y eficiente que le permitirá crear áreas de trabajo perfectas donde se aprovecha el espacio disponible totalmente.<br>Especificaciones:</p><ul><li><strong>Tableros:</strong> de 18 o 24 mm.</li><li>Estructura metálica: Estructura de acero laminado en frío de 2” con acabados pintura electroestática de alta resistencia a roces y ralladuras.</li><li><strong>Regulación:</strong> sistema de regulación de altura en cada pata.</li><li><strong>Acabados estructura metálica:</strong> negro, nopal, blanco, gris claro y aluminio.</li><li><strong>Separador central:</strong> de melamina o de vidrio o acrílico.</li></ul>', 'pro_imagen_default' => 'visso-sistemas-modulares-bench.jpg'],



            // ARESLINE - AMADEUS
            ['cat_id' => 16, 'pro_nombre' => 'AMADEUS', 'pro_descripcion' => '<p>Una silla elegante y con acabados cuidados, también está disponible con el brazo completamente tapizado. La forma, moderna y actual, evoca claros elementos tradicionales, principalmente en la alineación del brazo con el respaldo. Amadeus es la solución perfecta para despachos importantes y salas de espera confortables.</p>', 'pro_imagen_default' => 'aresline-amadeus-02.jpg'],
            ['cat_id' => 16, 'pro_nombre' => 'AMADEUS', 'pro_descripcion' => '<p>Una silla elegante y con acabados cuidados, también está disponible con el brazo completamente tapizado. La forma, moderna y actual, evoca claros elementos tradicionales, principalmente en la alineación del brazo con el respaldo. Amadeus es la solución perfecta para despachos importantes y salas de espera confortables.</p>', 'pro_imagen_default' => 'aresline-amadeus-03.jpg'],
            ['cat_id' => 16, 'pro_nombre' => 'AMADEUS', 'pro_descripcion' => '<p>Una silla elegante y con acabados cuidados, también está disponible con el brazo completamente tapizado. La forma, moderna y actual, evoca claros elementos tradicionales, principalmente en la alineación del brazo con el respaldo. Amadeus es la solución perfecta para despachos importantes y salas de espera confortables.</p>', 'pro_imagen_default' => 'aresline-amadeus-05.jpg'],
            ['cat_id' => 16, 'pro_nombre' => 'AMADEUS', 'pro_descripcion' => '', 'pro_imagen_default' => 'aresline-amadeus-01.jpg'],
            ['cat_id' => 16, 'pro_nombre' => 'AMADEUS', 'pro_descripcion' => '', 'pro_imagen_default' => 'aresline-amadeus-04.jpg'],


            // ARESLINE - LINK-XPLUS
            ['cat_id' => 17, 'pro_nombre' => 'AMADEUS', 'pro_descripcion' => '<p>Importante sillón con prestaciones de confort de nivel absoluto. El alcochado sigue en el respaldo, integrando en un único conjunto, del asiento al apoyacabeza, su línea única y refinada. Mecanismos de regulación de muy alta calidad, diversos tipos de brazos, materiales y acabados de alta gama, nada se deja al azar en este sillón de dirección que une prestaciones y diseño de manera óptima</p>', 'pro_imagen_default' => 'aresline-xplus-02.jpg'],
            ['cat_id' => 17, 'pro_nombre' => 'AMADEUS', 'pro_descripcion' => '<p>Importante sillón con prestaciones de confort de nivel absoluto. El alcochado sigue en el respaldo, integrando en un único conjunto, del asiento al apoyacabeza, su línea única y refinada. Mecanismos de regulación de muy alta calidad, diversos tipos de brazos, materiales y acabados de alta gama, nada se deja al azar en este sillón de dirección que une prestaciones y diseño de manera óptima</p>', 'pro_imagen_default' => 'aresline-xplus-03.jpg'],
            ['cat_id' => 17, 'pro_nombre' => 'AMADEUS', 'pro_descripcion' => '', 'pro_imagen_default' => 'aresline-xplus-04.jpg'],
            ['cat_id' => 17, 'pro_nombre' => 'AMADEUS', 'pro_descripcion' => '', 'pro_imagen_default' => 'aresline-xplus-01.jpg'],


            // ARESLINE - PARLAMENT
            ['cat_id' => 18, 'pro_nombre' => 'AMADEUS', 'pro_descripcion' => '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>', 'pro_imagen_default' => 'aresline-parlament-02.jpg'],
            ['cat_id' => 18, 'pro_nombre' => 'AMADEUS', 'pro_descripcion' => '', 'pro_imagen_default' => 'aresline-parlament-01.jpg'],
            ['cat_id' => 18, 'pro_nombre' => 'AMADEUS', 'pro_descripcion' => '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>', 'pro_imagen_default' => 'aresline-parlament-04.jpg'],
            ['cat_id' => 18, 'pro_nombre' => 'AMADEUS', 'pro_descripcion' => '', 'pro_imagen_default' => 'aresline-parlament-03.jpg'],

            // ARESLINE - PF3
            ['cat_id' => 19, 'pro_nombre' => 'AMADEUS', 'pro_descripcion' => '<p>La colección PF3 presenta un mobiliario completo especialmente diseñado para los salones más exclusivos, con un producto versátil, innovador y a la vez atractivo y cómodo. Una línea de descanso única que expresa una visión original del mundo de la decoración.</p>', 'pro_imagen_default' => 'aresline-pf3-01.jpg'],
            ['cat_id' => 19, 'pro_nombre' => 'AMADEUS', 'pro_descripcion' => '', 'pro_imagen_default' => 'aresline-pf3-03.jpg'],
            ['cat_id' => 19, 'pro_nombre' => 'AMADEUS', 'pro_descripcion' => '', 'pro_imagen_default' => 'aresline-pf3-04.jpg'],
            ...
            ['cat_id' => 20, 'pro_nombre' => 'AMADEUS', 'pro_descripcion' => '', 'pro_imagen_default' => 'aresline-trendy-04.jpg'],
            ['cat_id' => 20, 'pro_nombre' => 'AMADEUS', 'pro_descripcion' => '', 'pro_imagen_default' => 'aresline-trendy-05.jpg'],

            // ARESLINE - XTEN
            ['cat_id' => 21, 'pro_nombre' => 'AMADEUS', 'pro_descripcion' => '<p>El estímulo fuerte y continuo propuesto por Pininfarina en términos de investigación tecnológica, soluciones de ingeniería y atención al valor estético del producto, han producido soluciones contemporáneas y avanzadas desde el punto de vista ergonómico.</p>', 'pro_imagen_default' => 'aresline-xten-02.jpg'],
            ['cat_id' => 21, 'pro_nombre' => 'AMADEUS', 'pro_descripcion' => '', 'pro_imagen_default' => 'aresline-xten-01.jpg'],
            ['cat_id' => 21, 'pro_nombre' => 'AMADEUS', 'pro_descripcion' => '<p>El estímulo fuerte y continuo propuesto por Pininfarina en términos de investigación tecnológica, soluciones de ingeniería y atención al valor estético del producto, han producido soluciones contemporáneas y avanzadas desde el punto de vista ergonómico.</p>', 'pro_imagen_default' => 'aresline-xten-03.jpg'],
            ['cat_id' => 21, 'pro_nombre' => 'AMADEUS', 'pro_descripcion' => '', 'pro_imagen_default' => 'aresline-xten-04.jpg'],
    ...
    <li>Sistema de iluminación</li>
                ...
                ['cat_id' => 27, 'pro_nombre' => 'SIT STAND', 'pro_descripcion' => '<ul>
                    ...
                    </ul>', 'pro_imagen_default' => 'quadri-mobiliario-sit-stand.jpg'],
