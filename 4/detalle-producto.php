	...
	<div class="row">
		<div class="col-md-10 col-sm-12 col-md-offset-1">
			<div class="col-lg-12 col-sm-12">
				<span class="title">Nombre del producto</span>
			</div>
		    	...
		    	<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-6">
						...
						<div class="product-main-image-container">
							<img src="img/loader.gif" alt="" class="product-loader">
							<span class="thumbnail product-main-image">
								<img src="img/confort_2.jpg" alt="">
							</span>
						</div>
						<!-- End Main Image -->
						...
						<div class="col-xs-3 product-thumb-image">
							<a href="img/Integra_2.jpg" class="thumbnail">
								<img src="img/Integra_2.jpg" alt="">
							</a>
						</div>
						<div class="col-xs-3 product-thumb-image">
							<a href="img/Credenza_porta_documentos.jpg" class="thumbnail">
								<img src="img/Credenza_porta_documentos.jpg" alt="">
							</a>
						</div>
						<!-- End Thumbnail Image -->
					</div>
								...
								<div class="col-xs-12 input-qty-detail">
									...
									<div class="col-xs-9">
										<button class="btn btn-default pull-left">
											<i class="fa fa-shopping-cart"></i> Quiero
										</button>
									</div>
								</div>
			...
			<div class="col-lg-4 col-sm-4 hero-feature text-center">
		        <div class="thumbnail">
		        	<a href="detail.html" class="link-p">
		            	<img src="img/Almacenero_puertas_batientes.jpg" alt="">
		        	</a>
		    ...
		    <div class="col-lg-4 col-sm-4 hero-feature text-center">
		        <div class="thumbnail">
		        	<a href="detail.html" class="link-p">
		            	<img src="img/Quadra_multiple_recto.jpg" alt="">
		        	</a>
		            <div class="caption prod-caption">
		    ...
		    <div class="col-lg-4 col-sm-4 hero-feature text-center">
		        <div class="thumbnail">
		        	<a href="detail.html" class="link-p">
		            	<img src="img/Paneles_de_1.74_m.jpg" alt="">
		        	</a>
		            <div class="caption prod-caption">
